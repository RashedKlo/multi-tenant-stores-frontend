    ...
    <div className="border-t border-border bg-background/95 p-3 backdrop-blur supports-[backdrop-filter]:bg-background/80">
      <div className="flex items-end gap-2">
        <textarea
          ...
          className="max-h-[120px] min-h-11 flex-1 resize-none rounded-2xl border border-border bg-card px-4 py-2.5 text-sm text-foreground outline-none ring-primary/30 placeholder:text-muted-foreground focus:ring-2 disabled:opacity-50"
        />
        <button
          type="button"
          onClick={submit}
